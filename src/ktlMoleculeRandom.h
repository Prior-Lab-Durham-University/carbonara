...
public:
  ...
  const std::vector<int>& getUnitNos() const;
  const std::vector<std::vector<point> >& getTangents() const;
  const std::vector<std::vector<point> >& getNormals() const;
  const std::vector<std::vector<point> >& getBinormals() const;
  const std::vector<std::vector<point> >& getCoordinates() const;
  const std::vector<std::vector<std::string> >& getAminoList() const;
  const std::vector<point>& getCoordinatesSection(int i) const;
  ...
  const std::vector<double>& getDistChanges() const;
  ...
  const std::vector<double>& getDistSet() const;
