...
def run_initial_foxs_check(pdb_name, saxs_name, foxs_cmd="pyfoxs", max_q=None, protein_only=True, prepared_saxs_name=None, run_dir=None, keep_temp_inputs=False, plot_out=None):
    """
